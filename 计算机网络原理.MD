...
![image-20200603203603889](img/Network/image-20200603203603889.png)
...
![image-20200603204338746](img/Network/image-20200603204338746.png)
...
![计算机通过适配器和局域网进行通信 ](img/Network/image-20200603220411410.png)
计算机通过适配器和局域网进行通信 
...
![image-20200605113321840](img/Network/image-20200605113321840.png)
...
![image-20200605114055211](img/Network/image-20200605114055211.png)
...
![image-20200605115110122](img/Network/image-20200605115110122.png)
...
![image-20200605165522948](img/Network/image-20200605165522948.png)
...
![image-20200605165656334](img/Network/image-20200605165656334.png)
![image-20200605165741334](img/Network/image-20200605165741334.png)
...
![image-20200605165844957](img/Network/image-20200605165844957.png)
...
由于历史的原因，许多有关 TCP/IP 的文献将网络层使用的路由器称为**网关**。![image-20200605170148441](img/Network/image-20200605170148441.png)
虚拟互连网络的**意义**
...
![image-20200605170323300](img/Network/image-20200605170323300.png)
如果我们只从网络层考虑问题，那么 IP 数据报就可以想象是在网络层中传送
![image-20200605170346129](img/Network/image-20200605170346129.png)
...
![image-20200605170745601](img/Network/image-20200605170745601.png)
![image-20200605170757057](img/Network/image-20200605170757057.png)
![image-20200605170818813](img/Network/image-20200605170818813.png)
...
**2.常用的三种类别的 IP 地址**
IP 地址的指派范围
![image-20200605171040115](img/Network/image-20200605171040115.png)
**一般不使用的特殊的 IP 地址**
...
![image-20200609185749398](img/Network/image-20200609185749398.png)
![image-20200609185942877](img/Network/image-20200609185942877.png)
...
![image-20200609190113602](img/Network/image-20200609190113602.png)**4.2.4 地址解析协议 ARP**
...
**ARP 分组封装在物理网络的帧中传输。**
![image-20200609190717815](img/Network/image-20200609190717815.png)
ARP 高速缓存的**作用**
...
![image-20200609214001565](img/Network/image-20200609214001565.png)
...
![image-20200609214911225](img/Network/image-20200609214911225.png)
![image-20200609214920402](img/Network/image-20200609214920402.png)

首部检验和
![image-20200609214952129](img/Network/image-20200609214952129.png)
...
![image-20200609215341605](img/Network/image-20200609215341605.png)
...
![image-20200609215555145](img/Network/image-20200609215555145.png)
...
最后就将 IP 数据报直接交付目的主机。
![image-20200609215921622](img/Network/image-20200609215921622.png)

![image-20200609220143665](img/Network/image-20200609220143665.png)
当没有划分子网时，IP 地址是两级结构。
划分子网后 IP 地址就变成了三级结构。
...
(IP 地址) AND (子网掩码)=网络地址
![image-20200609221115213](img/Network/image-20200609221115213.png)
![image-20200609221130615](img/Network/image-20200609221130615.png)
**子网掩码是一个网络或一个子网的重要属性**。
...
![image-20200609222126763](img/Network/image-20200609222126763.png)
![image-20200609222138969](img/Network/image-20200609222138969.png)
![image-20200609222151416](img/Network/image-20200609222151416.png)
...
要发送的分组的目的 IP 地址：128.30.33.138![image-20200609224640949](img/Network/image-20200609224640949.png)
因此 H1 首先检查主机128.30.33.138 是否连接在本网络上如果是，则直接交付；否则，就送交路由器 R1，并逐项查找路由表。
![image-20200609224739304](img/Network/image-20200609224739304.png)
...
无分类的两级编址的记法是：
![image-20200609225333951](img/Network/image-20200609225333951.png)
...
![image-20200609231034741](img/Network/image-20200609231034741.png)
构成超网
...
![image-20200609232555060](img/Network/image-20200609232555060.png)
...
![image-20200609233730698](img/Network/image-20200609233730698.png)
...
ICMP 报文的格式 
![image-20200610163932999](img/Network/image-20200610163932999.png)
**4.4.1  ICMP 报文的种类**
...
![image-20200610164213365](img/Network/image-20200610164213365.png)
...
(4)返回。
![image-20200610182152726](img/Network/image-20200610182152726.png)
3 .RIP2 协议的报文格式 
![image-20200610182339973](img/Network/image-20200610182339973.png)
RIP2 报文由首部和路由部分组成。
...
OSPF 划分为两种不同的区域 
![image-20200610184613304](img/Network/image-20200610184613304.png)
...
![image-20200610190203358](img/Network/image-20200610190203358.png)
...
![image-20200610190322547](img/Network/image-20200610190322547.png)
![image-20200610190339804](img/Network/image-20200610190339804.png)
...
![image-20200610201742842](img/Network/image-20200610201742842.png)
...
![image-20200610201909551](img/Network/image-20200610201909551.png)
...
![image-20200610202215505](img/Network/image-20200610202215505.png)
![image-20200610202222726](img/Network/image-20200610202222726.png)
分组丢弃 
...
![image-20200610202514920](img/Network/image-20200610202514920.png)
