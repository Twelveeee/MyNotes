...
通过[pages.json](https://uniapp.dcloud.io/collocation/pages?id=%e9%85%8d%e7%bd%ae%e9%a1%b9%e5%88%97%e8%a1%a8)来配置页面
...
通过style修改页面的style，标题和导航栏背景色，并且设置h5下拉刷新的特有样式
...
如果应用是一个多 tab 应用，可以通过 tabBar 配置项指定 tab 栏的表现，以及 tab 切换时显示的对应页。[Tabbar](https://uniapp.dcloud.io/collocation/pages?id=tabbar)
...
[官方文档](https://uniapp.dcloud.io/component/README?id=%e7%bb%84%e4%bb%b6%e4%bd%bf%e7%94%a8%e7%9a%84%e5%85%a5%e9%97%a8%e6%95%99%e7%a8%8b)
...
在页面中需要定义数据，和vue一摸一样，直接在data中定义数据即可
